...
public class JdbcPersonDAOImpl implements PersonDAO {
    ...
    private static final String SQL_FIND_PERSON = "select id,first_name,sur_name,balance,address,phone from person where id = ?";
    private static final String SQL_DELETE_PERSON = "delete from person where id = ?";
    private static final String SQL_UPDATE_PERSON = "update person set first_name = ?, sur_name = ?, balance  = ?, address = ?, phone = ? where id = ?";
    private static final String SQL_GET_ALL = "select id,first_name,sur_name,balance,address,phone from person ORDER BY id ASC";
    private static final String SQL_INSERT_PERSON = "insert into person(first_name, sur_name, balance, address, phone) values(?,?,?,?,?);";
